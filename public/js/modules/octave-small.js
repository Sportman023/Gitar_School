      ...
      screen.append(
        ...
        el('div', { class: 'memo' },
          ...
          el('ul', { class: 'memo__list' },
            el('li', null, 'Добавочные линеечки считают сверху вниз: на первой сидит До 1 октавы, на второй — Ля малой, на третьей — Фа малой'),
            el('li', null, 'Между линеечками прячутся Си, Соль и Ми малой октавы'),
            el('li', null, 'Си малой — прямо под той линеечкой, с которой начинается первая октава'),
            el('li', null, 'Штиль у всех нот малой октавы смотрит вверх: они висят низко под станом'),
          )),
      );
    }
