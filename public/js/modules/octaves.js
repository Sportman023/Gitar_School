    ...
    function render() {
      ...
      screen.append(
        el('p', { class: 'lead' },
          ...
          + 'Каждый такой круг — октава.'),
        colorToggle(render),

        el('div', { class: 'staff-row staff-row--long' },
        ...
        el('p', { class: 'caption' },
          ...
          + 'До 2 октавы стоит сразу после Си 1 октавы.'),
        ...
        el('div', { class: 'memo' },
          ...
          el('ul', { class: 'memo__list' },
            el('li', null, '1 октава живёт внизу стана: от До на добавочной линеечке до Си на 3-й линейке'),
            el('li', null, '2 октава — наверху: её До стоит между 3-й и 4-й линейками'),
